...
var _association = require('./associations/association');
...
var _forIn2 = require('lodash/object/forIn');
...
var Schema = function () {
  function Schema(db) {
    ...
    (0, _assert2.default)(db, 'A schema requires a db');
  ...
  _createClass(Schema, [{
    ...
    value: function registerModels() {
      ...
      (0, _forIn3.default)(hash, function (model, key) {
    ...
    value: function registerModel(type, ModelClass) {
      ...
      var camelizedModelName = (0, _inflector.camelize)(type);
      ...
      for (var associationProperty in ModelClass.prototype) {
        if (ModelClass.prototype[associationProperty] instanceof _association2.default) {
          var association = ModelClass.prototype[associationProperty];
          association.key = associationProperty;
          association.modelName = association.modelName || (0, _inflector.dasherize)((0, _inflector.singularize)(associationProperty));
          association.ownerModelName = (0, _inflector.dasherize)(camelizedModelName);
      ...
      var collection = (0, _inflector.pluralize)(camelizedModelName);
      if (!this.db[collection]) {
        this.db.createCollection(collection);
      }

      // Create the entity methods
      this[(0, _inflector.pluralize)(camelizedModelName)] = {
    ...
    value: function find(type, ids) {
      ...
      if ((0, _isArray3.default)(ids)) {
        (0, _assert2.default)(records.length === ids.length, 'Couldn\'t find all ' + (0, _inflector.pluralize)(type) + ' with ids: (' + ids.join(',') + ') (found ' + records.length + ' results, but was looking for ' + ids.length + ')');
      }
    ...
    */
    ...
    value: function _collectionForType(type) {
      var collection = (0, _inflector.pluralize)(type);
      (0, _assert2.default)(this.db[collection], 'You\'re trying to find model(s) of type ' + type + ' but this collection doesn\'t exist in the database.');
    ...
    value: function _addForeignKeyToRegistry(type, fk) {
      ...
      if (!(0, _includes3.default)(fks, fk)) {
        fks.push(fk);
      }
    }
