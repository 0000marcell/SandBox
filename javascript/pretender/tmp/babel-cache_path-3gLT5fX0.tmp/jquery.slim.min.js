define("jquery.slim.min", ["exports"], function (exports) {
    ...
    "use strict";var c = [],
      ...
      return a.getAttribute && a.getAttribute("class") || "";
        ...
        var b,
          ...
          b = a.match(K) || [];while (c = this[i++]) if ((e = ab(c), d = 1 === c.nodeType && (" " + e + " ").replace(_a, " "))) {
        ...
        var b,
            c,
            d = 0;b = " " + a + " ";while (c = this[d++]) if (1 === c.nodeType && (" " + ab(c) + " ").replace(_a, " ").indexOf(b) > -1) return !0;return !1;
      } });var bb = /\r/g,
      ...
      r.valHooks[this] = { set: function set(a, b) {
        ...
        var g,
          ...
          if (!f && !n.noBubble && !r.isWindow(e)) {
            for (j = n.delegateType || p, db.test(j + p) || (h = h.parentNode); h; h = h.parentNode) o.push(h), i = h;i === (e.ownerDocument || d) && o.push(i.defaultView || i.parentWindow || a);
