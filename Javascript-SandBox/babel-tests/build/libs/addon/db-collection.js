...
exports.IdentityManager = undefined;
  ...
  _createClass(DbCollection, [{
    ...
    value: function insert(data) {
      if (!(0, _isArray3.default)(data)) {
        ...
        return (0, _sortBy3.default)(data, 'id').map(this._insertRecord, this);
      }
    }
    ...
    value: function firstOrCreate(query) {
      ...
      if (record) {
        ...
        var mergedAttributes = (0, _assign3.default)(attributesForCreate, query);
      ...
      if (typeof attrs === 'undefined') {
        var _ret = function () {
          ...
          _this._records.forEach(function (record) {
            var oldRecord = (0, _assign3.default)({}, record);

            _this._updateRecord(record, attrs);

            if (!(0, _isEqual3.default)(oldRecord, record)) {
        ...
        return record;
      } else if ((0, _isArray3.default)(target)) {
        var ids = target;
