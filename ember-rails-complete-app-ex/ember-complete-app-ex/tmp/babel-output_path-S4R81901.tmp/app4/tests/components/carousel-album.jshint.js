define('app4/tests/components/carousel-album.jshint', ['exports'], function (exports) {
  ...
  QUnit.test('should pass jshint', function (assert) {
    assert.expect(1);
    assert.ok(false, 'components/carousel-album.js should pass jshint.\ncomponents/carousel-album.js: line 80, col 54, Expected an assignment or function call and instead saw an expression.\ncomponents/carousel-album.js: line 44, col 32, \'$\' is not defined.\n\n2 errors');
  });
});