define('app4/tests/acceptance/users/user/todos-test', ['exports', 'ember', 'qunit', 'app4/tests/helpers/start-app', 'app4/tests/helpers/module-for-acceptance', 'app4/tests/helpers/ember-simple-auth'], function (exports, _ember, _qunit, _app4TestsHelpersStartApp, _app4TestsHelpersModuleForAcceptance, _app4TestsHelpersEmberSimpleAuth) {

	var application = undefined,
	    user = undefined;

	(0, _app4TestsHelpersModuleForAcceptance['default'])('Acceptance | users/user/todos', {
		beforeEach: function beforeEach() {
			application = (0, _app4TestsHelpersStartApp['default'])();
			user = server.create('user');
			(0, _app4TestsHelpersEmberSimpleAuth.authenticateSession)(application);
		},
