...
var Model = function () {
  function Model(schema, modelName, attrs, fks) {
    ...
    (0, _assert2.default)(schema, 'A model requires a schema');
    (0, _assert2.default)(modelName, 'A model requires a modelName');
  ...
  _createClass(Model, [{
    key: 'save',
    value: function save() {
      var collection = (0, _inflector.pluralize)((0, _inflector.camelize)(this.modelName));
    ...
    value: function isNew() {
      ...
      if (hasId) {
        var collectionName = (0, _inflector.pluralize)((0, _inflector.camelize)(this.modelName));
    ...
    value: function _setupAttrs(attrs) {
      ...
      Object.keys(attrs).filter(function (key) {
        var value = attrs[key];
        return value instanceof Model || value instanceof _collection2.default;
      }).forEach(function (key) {
        var modelOrCollection = attrs[key];

        (0, _assert2.default)(_this.associationKeys.indexOf(key) > -1, 'You\'re trying to create a ' + _this.modelName + ' model and you passed in a ' + modelOrCollection.toString() + ' under the ' + key + ' key, but you haven\'t defined that key as an association on your model.');
      });
