...
var _invoke2 = require('lodash/collection/invoke');
...
var Collection = function () {
  function Collection(modelName) {
    ...
    (0, _assert2.default)(modelName && typeof modelName === 'string', 'You must pass a `modelName` into a Collection');
  ...
  _createClass(Collection, [{
    ...
    value: function update() {
      ...
      _invoke3.default.apply(undefined, [this.models, 'update'].concat(args));
    ...
    value: function destroy() {
      (0, _invoke3.default)(this.models, 'destroy');
    ...
    key: 'save',
    value: function save() {
      (0, _invoke3.default)(this.models, 'save');
    ...
    value: function reload() {
      (0, _invoke3.default)(this.models, 'reload');
