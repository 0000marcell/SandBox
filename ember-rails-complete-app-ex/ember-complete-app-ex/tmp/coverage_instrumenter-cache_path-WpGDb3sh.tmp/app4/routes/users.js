...
if (!__cov_t$QGoc$sZStE7IVDRiXRcQ.__coverage__) { __cov_t$QGoc$sZStE7IVDRiXRcQ.__coverage__ = {}; }
...
import Ember from'ember';import AuthenticatedRouteMixin from'ember-simple-auth/mixins/authenticated-route-mixin';export default Ember.Route.extend(AuthenticatedRouteMixin,{model(){__cov_t$QGoc$sZStE7IVDRiXRcQ.f['1']++;__cov_t$QGoc$sZStE7IVDRiXRcQ.s['1']++;return this.store.findAll('user');}});
