...
if (!__cov_IP4B3FoDCLGLGrD56BAFaw.__coverage__) { __cov_IP4B3FoDCLGLGrD56BAFaw.__coverage__ = {}; }
...
import OAuth2PasswordGrant from'ember-simple-auth/authenticators/oauth2-password-grant';export default OAuth2PasswordGrant.extend({serverTokenEndpoint:'/oauth/token'});
