define('app4/routes/users/user/todos/todo', ['exports', 'ember'], function (exports, _ember) {
   ...
   if (!__cov_fbEbUVqKwyDbVW3tkySIeA.__coverage__) {
      __cov_fbEbUVqKwyDbVW3tkySIeA.__coverage__ = {};
   }
   ...
   exports['default'] = _ember['default'].Route.extend({ model: function model(param) {
         __cov_fbEbUVqKwyDbVW3tkySIeA.f['1']++;__cov_fbEbUVqKwyDbVW3tkySIeA.s['1']++;return this.store.find('todo', param.id);
      } });
});