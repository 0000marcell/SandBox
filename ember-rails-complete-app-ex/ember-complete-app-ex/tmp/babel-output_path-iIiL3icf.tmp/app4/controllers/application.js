define('app4/controllers/application', ['exports', 'ember'], function (exports, _ember) {
   ...
   exports['default'] = _ember['default'].Controller.extend({ authManager: _ember['default'].inject.service('session'), actions: { logout: function logout() {
            __cov_qaGe43uoYZvGjbmStjfdBQ.f['1']++;__cov_qaGe43uoYZvGjbmStjfdBQ.s['1']++;this.get('authManager').invalidate();__cov_qaGe43uoYZvGjbmStjfdBQ.s['2']++;this.transitionToRoute('login');
         } } });
});