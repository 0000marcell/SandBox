define('app4/components/session-component', ['exports', 'ember'], function (exports, _ember) {
   ...
   if (!__cov_ru0Qf4HQZHv06HZ42pUU6A.__coverage__) {
      __cov_ru0Qf4HQZHv06HZ42pUU6A.__coverage__ = {};
   }
   ...
   exports['default'] = _ember['default'].Component.extend({ authManager: _ember['default'].inject.service('session'), actions: { logOut: function logOut() {
            __cov_ru0Qf4HQZHv06HZ42pUU6A.f['1']++;__cov_ru0Qf4HQZHv06HZ42pUU6A.s['1']++;this.get('onLogout')();
         } } });
});