...
import Ember from'ember';export default Ember.Route.extend({model(params){__cov_1L4Cxa0_3HKAqy8_FhVy7A.f['1']++;__cov_1L4Cxa0_3HKAqy8_FhVy7A.s['1']++;return this.store.query('todo',{page:{number:params.page,size:params.size},search:params.search});},queryParams:{page:{refreshModel:true},size:{refreshModel:true},search:{refreshModel:true}}});
