define('app4/routes/users/user/todos', ['exports', 'ember'], function (exports, _ember) {
   ...
   if (!__cov_CIsQgsOqTk_QXuOK$WnB3g.__coverage__) {
      __cov_CIsQgsOqTk_QXuOK$WnB3g.__coverage__ = {};
   }
   ...
   exports['default'] = _ember['default'].Route.extend({ model: function model(params) {
         __cov_CIsQgsOqTk_QXuOK$WnB3g.f['1']++;__cov_CIsQgsOqTk_QXuOK$WnB3g.s['1']++;return this.store.query('todo', { page: { number: params.page, size: params.size } });
      }, queryParams: { page: { refreshModel: true }, size: { refreshModel: true } } });
});