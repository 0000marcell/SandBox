...
var dir_of_interest = '/Users/marcell/Documents/github/C/general/produtorio';
...
function make_subscription(client, watch, relative_path) {
  ...
  client.on('subscription', function (resp) {
    exec('make all && ./build/produtorio', function(error, stdout, stderr){
      console.log(stdout);
    });
  });
}