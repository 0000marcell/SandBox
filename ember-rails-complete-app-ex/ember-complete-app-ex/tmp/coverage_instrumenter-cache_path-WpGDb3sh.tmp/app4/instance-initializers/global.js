...
if (!__cov_aIXerip5YaSjje9bt2yQ1Q.__coverage__) { __cov_aIXerip5YaSjje9bt2yQ1Q.__coverage__ = {}; }
...
export function initialize(application){__cov_aIXerip5YaSjje9bt2yQ1Q.f['1']++;__cov_aIXerip5YaSjje9bt2yQ1Q.s['2']++;application.store=application.lookup('service:store');__cov_aIXerip5YaSjje9bt2yQ1Q.s['3']++;window.App=application;}export default{name:'global',initialize:initialize};
