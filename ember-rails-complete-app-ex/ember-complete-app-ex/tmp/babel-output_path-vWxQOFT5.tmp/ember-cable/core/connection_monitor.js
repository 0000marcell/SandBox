define('ember-cable/core/connection_monitor', ['exports', 'ember'], function (exports, _ember) {
  'use strict';

  var ConnectionMonitor = _ember['default'].Object.extend({
    connection: null,
    stoppedAt: null,
    startedAt: null,
    pingedAt: null,
  ...
  ConnectionMonitor[_ember['default'].NAME_KEY] = 'ConnectionMonitor';
