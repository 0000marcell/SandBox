...
var _compose2 = require('lodash/function/compose');
...
var Serializer = function () {
  ...
  _createClass(Serializer, [{
    ...
    value: function oldSerialize(response, request) {
      if (response instanceof _model2.default) {
    ...
    value: function keyForRelationship(modelName) {
      return (0, _compose3.default)(_inflector.camelize, _inflector.pluralize)(modelName);
    }
    ...
    value: function keyForRelationshipIds(modelName) {
      return (0, _inflector.singularize)((0, _inflector.camelize)(modelName)) + 'Ids';
    }
    ...
    value: function _serializeModel(model, request) {
      ...
      return (0, _assign3.default)(attrs, relatedAttrs);
    }
    ...
    value: function _oldAttrsForModel(model) {
      ...
      if (this.attrs) {
        ...
        attrs = (0, _assign3.default)(attrs, model.attrs);
      }
    ...
    value: function _serializeSideloadedModelResponse(model, request) {
      ...
      if (topLevelIsArray) {
        key = root ? root : (0, _inflector.pluralize)(key);
      ...
      this._valueForInclude(this, request).map(function (key) {
        return model[(0, _inflector.camelize)(key)];
    ...
    value: function _attrsForRelationships(model, request) {
      ...
      return this._valueForInclude(this, request).reduce(function (attrs, key) {
        var modelOrCollection = model[(0, _inflector.camelize)(key)];
        ...
        if (relatedAttrs) {
          if (_this6.isModel(modelOrCollection)) {
            attrs[_this6.keyForModel(key)] = relatedAttrs;
          } else {
            attrs[_this6.keyForRelationship(key)] = relatedAttrs;
          }
        }
    ...
    value: function _hasBeenSerialized(model) {
      var relationshipKey = (0, _inflector.camelize)(model.modelName) + 'Ids';
    ...
    value: function _augmentAlreadySerialized(model) {
      var modelKey = (0, _inflector.camelize)(model.modelName) + 'Ids';
    ...
    value: function _valueForInclude(serializer, request) {
      ...
      if ((0, _isFunction3.default)(include)) {
...
Serializer.extend = _extend2.default;
