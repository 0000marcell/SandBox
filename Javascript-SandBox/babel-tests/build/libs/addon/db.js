...
var _dbCollection = require('./db-collection');

var _dbCollection2 = _interopRequireDefault(_dbCollection);
...
var Db = function () {
  ...
  _createClass(Db, [{
    ...
    value: function createCollection(name, initialData) {
      ...
      if (!this[name]) {
        (function () {
          var newCollection = new _dbCollection2.default(name, initialData);
